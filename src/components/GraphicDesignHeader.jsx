  ...
  return (
    ...
    ${
      isSticky
        ...
        : "lg:bg-white dark:bg-[#1d222f] lg:dark:bg-primaryDark"
    }`}
    >
      <Link to={"/"}>
        {/* {isSticky ? (
        ...
        <img
          src={darkMode ? assets.epahubb_logo_two : assets.epahubb_general_logo}
          ...
          <li className='flex items-center gap-1 relative cursor-pointer z-0 group py-[.6rem]'>
            <a
              ...
              className={`capitalize lg:text-[15px] xl:text-[17px] font-medium ${
                isSticky ? "dark:text-white" : "text-black dark:text-white"
              }`}
            >
              <span>Company</span>
            </a>
